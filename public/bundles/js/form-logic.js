...
var _formApi = _interopRequireDefault(__webpack_require__(7));

var _formParsers = _interopRequireDefault(__webpack_require__(2));

var _intlTelInput = _interopRequireDefault(__webpack_require__(9));
...
function () {
  ...
  (0, _createClass2.default)(Form, [{
    ...
    key: "setPhoneBlurEvent",
    value: function setPhoneBlurEvent(el) {
    ...
    value: function checkValidity() {
      ...
      if (this.$iti) {
        this.hideErrors(this.form); // reset block btn
    ...
    value: function setNextMethod(e) {
      ...
      var data = _formParsers.default.default.getExternalData(this.options, this.form);

      if (this.options.preReadRegFormCb) return this.getTokenForApp(data, this.form);

      if (this.options.registration) {
        return this.registration(_formParsers.default.default.getRegistrationData(data), this.form);
      }
    ...
    value: function registration(data, form) {
      ...
      _formApi.default.default.apiRegistration(data, this.options.internal, this.options.partnerTags, this.options.loadCb, function (result, response) {
        if (result) {
        ...
        return _formParsers.default.default.afterErrorSend(response, form, function (error, type, form) {
    ...
    value: function getTokenForApp(data, form) {
      ...
      _formApi.default.default.apiGetToken(data, this.options.internal, this.options.partnerTags, this.options.loadCb, function (apiData) {
        if (apiData.result) {
          ...
          return _formParsers.default.default.afterErrorSend(apiData.response, form, function (error, type, form) {
            if (_this.options.errorRegSendCb) {
    ...
    value: function readRegistration(data, form) {
      ...
      _formApi.default.default.apiReadRegistration(data, this.options.internal, this.options.partnerTags, this.options.loadCb, function (apiData) {
        if (apiData.sendApp) {
          var token = apiData.response.meta.token;
          ...
          return _formParsers.default.default.afterErrorSend(errorResponse, form, function (error, type, form) {
            if (_this.options.errorRegSendCb) {
    ...
    value: function sendApplication(data, form, token) {
      ...
      _formApi.default.default.apiSendApplication(data, this.options.internal, this.options.partnerTags, token, this.options.loadCb, function (result, response) {
        if (result) {
    ...
    key: "showErrors",
    value: function showErrors(errors, parent) {
...
var _underscore = _interopRequireDefault(__webpack_require__(8));
