...
var _formApi = _interopRequireDefault(__webpack_require__(8));

var _formParsers = _interopRequireDefault(__webpack_require__(4));
  ...
  (0, _createClass2.default)(Form, [{
    ...
    value: function registration(data, form) {
      ...
      _formApi.default.apiRegistration(data, this.options.internal, this.options.partnerTags, this.options.loadCb, function (result, response) {
        ...
        return _formParsers.default.afterErrorSend(response, form, function (error, type, form) {
    ...
    value: function getTokenForApp(data, form) {
      ...
      _formApi.default.apiGetToken(data, this.options.internal, this.options.partnerTags, this.options.loadCb, function (apiData) {
        if (apiData.result) {
          ...
          return _formParsers.default.afterErrorSend(apiData.response, form, function (error, type, form) {
            if (_this.options.errorRegSendCb) {
    ...
    value: function readRegistration(data, form) {
      ...
      _formApi.default.apiReadRegistration(data, this.options.internal, this.options.partnerTags, this.options.loadCb, function (apiData) {
        if (apiData.sendApp) {
          ...
          return _formParsers.default.afterErrorSend(errorResponse, form, function (error, type, form) {
            if (_this.options.errorRegSendCb) {
...
var _lodash = _interopRequireDefault(__webpack_require__(3));

var _formParsers = _interopRequireDefault(__webpack_require__(4));

var _refreshToken = _interopRequireDefault(__webpack_require__(11));
...
function _default() {
  return new Promise(function (resolve) {
    _jquery.default.ajax({
      ...
      success: function success(response) {
        resolve((0, _defineProperty2.default)({}, k('Y.DTSG.Uplfo'), (0, _md.default)("".concat(_lodash.default.get(response, k('ebub/buusjcvuft/ydtsg'))).concat(k('wXbwV2MRTCFsFxxPc59p5:Iv{LZ:HOmq')))));
      }
    });
  });
}
