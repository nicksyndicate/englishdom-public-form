...
var Form = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Form, [{
    ...
    value: function checkValidity(parent) {
      var errorMap = document.body.getAttribute('data-language') === 'ua' ? ['Невірний номер', 'Такого коду країни не існує', 'Номер дуже короткий', 'Номер занадто довгий', 'Невірний номер'] : ['Неправильный номер', 'Такого кода страны не существует', 'Номер слишком короткий', 'Номер слишком длинный', 'Неправильный номер'];
