...
var _formApi = _interopRequireDefault(__webpack_require__(9));

var _formParsers = _interopRequireDefault(__webpack_require__(3));

var _intlTelInput = _interopRequireDefault(__webpack_require__(11));
...
function () {
  function Form(options) {
    ...
    if (this.options.phone) {
      this.$iti = _intlTelInput.default.default(this.form);
...
var _underscore = _interopRequireDefault(__webpack_require__(10));
...
(function () {
  ...
  var eq = function eq(a, b, aStack, bStack) {
    ...
    if (!areArrays) {
      if ((0, _typeof2.default)(a) != 'object' || (0, _typeof2.default)(b) != 'object') return false; // Objects with different constructors are not equivalent, but `Object`s or `Array`s
